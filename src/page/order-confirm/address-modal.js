/*
* @Author: yangmei
* @Date:   2018-01-01 15:12:53
* @Last Modified by:   yangmei
* @Last Modified time: 2018-01-01 23:11:59
*/
...
var addressModal = {
     ...
     bindEvent :  function(){
        ...
        this.$modalWrap.find('.address-btn').click(function(){
            ...
            // 验证不通过
                ...
                _em.errorTips(receiverInfo.errMsg || '好像哪里不对了~');
            }
        });
    ...
    loadModal : function(){
        var addressModalHtml = _em.renderHtml(templateAddressModal, {
